...
.DESCRIPTION
    ...
    2. Copies the resulting 'broadcast-shared-1.0.0.jar' to the 'geode-scripts' directory.
...
$sourceJar = "broadcast-microservice/broadcast-shared/target/broadcast-shared-1.0.0.jar"
$destinationJar = "geode-scripts/broadcast-shared-1.0.0.jar"
