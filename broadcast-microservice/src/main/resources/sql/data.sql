...
('user-001', 'session-001', 'pod-001', 'ACTIVE', CURRENT_TIMESTAMP),
('user-002', 'session-002', 'pod-001', 'ACTIVE', CURRENT_TIMESTAMP),
('user-003', 'session-003', 'pod-002', 'ACTIVE', CURRENT_TIMESTAMP),
('user-004', 'session-004', 'pod-002', 'INACTIVE', CURRENT_TIMESTAMP),
('user-005', 'session-005', 'pod-003', 'ACTIVE', CURRENT_TIMESTAMP);
